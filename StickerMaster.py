...
class StickerGeneratorApp(QWidget):
    ...
    def create_IME_box_form_elements(self):
        ...
        self.va_IME_box_label = QLabel("Навантаження VA:")
    ...
    def create_IME_box_tab(self):
        ...
        input_layout.addWidget(self.nominal_IME_box_label, 1, 0)
        input_layout.addWidget(self.nominal_IME_box_input, 1, 1)

        input_layout.addWidget(self.short_prefix_IME_box_label, 2, 0)
        input_layout.addWidget(self.short_prefix_IME_box_input, 2, 1)
    ...
    def show_IME_standard_preview(self):
        ...
        self.modify_pdf(self.template_path, doc_output, f"{prefix}0001", date_code, nominal, va, short_prefix)
    ...
    def show_IME_box_preview(self):
        ...
        self.temp_preview_path = os.path.join(os.getcwd(), "tmp_preview.pdf")
        doc_output = fitz.open()
        self.modify_pdf(self.template_path, doc_output, f"{short_prefix}0001", date_code, nominal, va, short_prefix)
        doc_output.save(self.temp_preview_path)
        doc_output.close()
    ...
    def generate_IME_standard_pdfs(self):
        ...
        prefix = self.prefix_IME_standard_input.text()
        short_prefix = self.prefix_IME_standard_input.text()
    ...
    def generate_IME_box_pdfs(self):
        ...
        for i in range(1, count + 1):
            serial_number = None
            self.modify_pdf(self.template_path, doc_output, serial_number, date_code, nominal, va, short_prefix)
    ...
    def modify_pdf(self, input_pdf, doc_output, serial_number, date_code, nominal, va, short_prefix):
        doc = fitz.open(input_pdf)
